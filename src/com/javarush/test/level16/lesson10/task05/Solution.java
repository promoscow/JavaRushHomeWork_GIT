...
public class Solution {
    ...
    public static class Water implements Runnable {
        ...
        public void run() {
            ...
            boolean isCurrentThreadInterrupted = Thread.currentThread().isInterrupted();            //непонятный для меня код
            String threadName = Thread.currentThread().getName();           //тоже взять на вооружение
